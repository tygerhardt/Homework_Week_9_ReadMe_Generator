...
async function main() {
    ...
    console.log(`starting`);
        ...
        for (i = 0; i < contributorUserNamesArray.length; i++) {
            ...
            console.log('contributorsGitUserName is: ', contributorsGitUserName);
...
`)
        ...
        var writeResult = await fs.writeFileSync(path.join(__dirname, '/output', '/readMe.md'), result)
        console.log("file generated....")

} catch(err){
    console.error('error in catch block is: ', err);
}
}
main();